<template>
  <div>
    ...
    <div class="bg-white-dark flex justify-center h-screen">
      ...
      >
        <img
          class="h-48 w-48 rounded-full mx-auto"
          src="~/static/austinAkersProfilePic.jpg"
        />
        <div class="text-center">
          <h1 class="text-3xl">Austin Akers</h1>
          <h2 class="text-xl">Sr. UI Engineer</h2>
          <p class="text-xl text-gray-600">me@austinakers.com</p>
          <div class="flex text-center">
            <div class="sm:w-1/2 md:w-1/3 p-3">
              <a href="https://github.com/BboyAkers" target="_blank">
                <svg
                  viewBox="0 0 128 128"
                  width="50"
                  height="50"
            ...
            <div class="sm:w-1/2 md:w-1/3 p-3">
              <a href="https://twitter.com/tweetmonster999" target="_blank">
                <svg
                  viewBox="0 0 128 128"
                  width="50"
                  height="50"
